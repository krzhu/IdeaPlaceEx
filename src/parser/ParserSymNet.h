...
/// @brief Parsing in the .symnet files. This file is simply the name of nets
/// that are symmetric or self-symmetric
class ParserSymNet {
public:
  /// @brief constructor
...
private:
  /// @brief process the pairs read from the file, and save the result in the
  /// database
...
private:
  ...
  std::vector<std::pair<std::string, std::string>>
      _pairs;                      ///< The pairs for the input symmetric net
