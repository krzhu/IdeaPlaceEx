...
public:
  ...
  const std::string pinFile() const {
    Assert(this->pinFileIsSet());
    return _pinFile;
  }
  ...
  const std::string netwgtFile() const {
    Assert(this->netwgtFileIsSet());
    return _netwgtFile;
  }
  ...
  const std::string connectionFile() const {
    Assert(this->connectionFileIsSet());
    return _connectionFile;
  }
  ...
  /// @brief get the .connection file file name
  /// @return the .connection file file name
  const std::string symFile() const {
    Assert(this->symFileIsSet());
    return _symFile;
  }
  ...
  const std::string symnetFile() const {
    Assert(this->symnetFileIsSet());
    return _symnetFile;
  }
  ...
  const std::string sigpathFile() const {
    Assert(this->sigpathFileIsSet());
    return _sigpathFile;
  }
  ...
  const std::string techsimpleFile() const {
    Assert(this->techsimpleFileIsSet());
    return _techsimpleFile;
  }
  ...
  void setNetwgtFile(const std::string &netwgtFile) {
    _netwgtFile = netwgtFile;
  }
  /// @brief set the .connection file
  /// @param the .connection file file name
  void setConnectionFile(const std::string &connectionFile) {
    _connectionFile = connectionFile;
  }
  /// @brief set the techsimple file
  /// @param the techsimple file file name
  void setTechsimpleFile(const std::string &techsimpleFile) {
    _techsimpleFile = techsimpleFile;
  }
  /// @brief set the symnet file
  /// @param the symnet file file name
  void setSymnetFile(const std::string &symnetFile) {
    _symnetFile = symnetFile;
  }
  /// @brief set the sigpath file
  /// @param the sigpath file file name
  void setSigpathFile(const std::string &sigpathFile) {
    _sigpathFile = sigpathFile;
  }
