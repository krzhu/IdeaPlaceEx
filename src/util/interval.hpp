...
namespace boost { namespace polygon {
    ...
    struct geometry_concept<PROJECT_NAMESPACE::Interval<CoordType>> { typedef interval_concept type; };
    ...
    struct interval_traits<PROJECT_NAMESPACE::Interval<CoordType>>
    {
        ...
        static inline coordinate_type get(const PROJECT_NAMESPACE::Interval<CoordType> &interval, direction_1d dir)
        {
            if (dir == LOW)
            {
    ...
    {
        typedef CoordType coordinate_type;
        static inline void set(PROJECT_NAMESPACE::Interval<CoordType> &interval, direction_1d dir, CoordType value)
        {
            if (dir == LOW)
            {
        ...
        static inline PROJECT_NAMESPACE::Interval<CoordType> construct(CoordType low_value, CoordType high_value)
        {
