...
constexpr IndexType NLP_WN_CONJ_DEFAULT_MAX_ITER = 50; ///< The default maxmimum iterations for the global placement
constexpr RealType NLP_WN_CONJ_EPISLON = 500 / NLP_WN_CONJ_DEFAULT_MAX_ITER ;
constexpr RealType NLP_WN_CONJ_DEFAULT_MAX_WHITE_SPACE = 0.3; ///< The default extra white space for setting the boundry
constexpr RealType NLP_WN_MAX_PENALTY = 50;
constexpr RealType NLP_WN_REDUCE_PENALTY = 30 / NLP_WN_MAX_PENALTY ;
