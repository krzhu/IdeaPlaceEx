...
constexpr double NLP_WN_CONJ_ASYM_THRESHOLD = 2.5; ///< The threshodl for whether increase the penalty for asymmetry
...
constexpr IndexType NLP_WN_CONJ_DEFAULT_MAX_ITER = 10; ///< The default maxmimum iterations for the global placement
