...
void initIdeaPlaceExAPI(py::module &m)
{
  py::class_<PROJECT_NAMESPACE::IdeaPlaceEx>(m , "IdeaPlaceEx")
    ...
    .def("setNetExternalBBox", &PROJECT_NAMESPACE::IdeaPlaceEx::setNetExternalBBox, "Set the external net bouding box of the circuit")
    ...
    .def("fpIoPinAssignLeft", &PROJECT_NAMESPACE::IdeaPlaceEx::fpIoPinAssignLeft, "set a net should be assigned to the left for IO pin")
    .def("fpIoPinAssignRight", &PROJECT_NAMESPACE::IdeaPlaceEx::fpIoPinAssignRight, "set a net should be assigned to the right for IO pin")
    .def("clearFpIoPinAssign", &PROJECT_NAMESPACE::IdeaPlaceEx::clearFpIoPinAssign, "Clear a net's IO Pin assignment")
    ...
    .def("openFastMode", &PROJECT_NAMESPACE::IdeaPlaceEx::openFastMode, "Open the placement fast mode. Notice that the constraints might be waived")
    .def("closeFastMode", &PROJECT_NAMESPACE::IdeaPlaceEx::closeFastMode, "Close the placement fast mode.")
    .def("setBoundaryConstraint", &PROJECT_NAMESPACE::IdeaPlaceEx::setBoundaryConstraint, "Set the boundary constraints. params: xLo, yLo, xHi, yHi")
    ...
    // Well
    .def("allocateWell", &PROJECT_NAMESPACE::IdeaPlaceEx::allocateWell, "Allocate a new well")
    .def("setWellName", &PROJECT_NAMESPACE::IdeaPlaceEx::setWellName, "Set the name of a well")
    .def("setWellShape", &PROJECT_NAMESPACE::IdeaPlaceEx::setWellShape, "Set the shape (polygon) of a well")
    .def("printWellInfo", &PROJECT_NAMESPACE::IdeaPlaceEx::printWellInfo, "Print the info of a well")
    ;
}
