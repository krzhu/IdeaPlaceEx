...
namespace nt
{
    ...
    template<typename nlp_numerical_type, typename nlp_coordinate_type>
    struct calc_operator_partial_build_cellmap_trait<diff::VerticalConstraintDifferentiable<nlp_numerical_type, nlp_coordinate_type>>
    {
        typedef diff::VerticalConstraintDifferentiable<nlp_numerical_type, nlp_coordinate_type> nlp_op_type;
        template<typename calc_type>
        static void build(nlp_op_type &op, calc_type &calc)
        {
            calc._numCells = 2; // Always have exactly two cells
    ...
    template<typename nlp_numerical_type, typename nlp_coordinate_type>
    struct calc_operator_partial_build_cellmap_trait<diff::HorizontalConstraintDifferentiable<nlp_numerical_type, nlp_coordinate_type>>
    {
        typedef diff::HorizontalConstraintDifferentiable<nlp_numerical_type, nlp_coordinate_type> nlp_op_type;
        template<typename calc_type>
        static void build(nlp_op_type &op, calc_type &calc)
        {
            calc._numCells = 2; // Always have exactly two cells
