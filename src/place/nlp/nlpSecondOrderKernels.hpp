 ...
 * @brief The non-lnear programming second order optimization kernel for global
 * plaement
 * @author Keren Zhu
 * @date 04/24/2020
 */
...
struct optm_trait<
    second_order::naive_gradient_descent<converge_criteria_type>> {
  typedef second_order::naive_gradient_descent<converge_criteria_type>
      optm_type;
  ...
  template <typename nlp_type,
            std::enable_if_t<nlp::is_second_order_diff<nlp_type>::value, void>
                * = nullptr>
...
template <typename converge_criteria_type, typename nlp_numerical_type>
struct optm_trait<
    second_order::adam<converge_criteria_type, nlp_numerical_type>> {
  typedef second_order::adam<converge_criteria_type, nlp_numerical_type>
      optm_type;
  typedef typename optm_type::converge_type converge_type;
  typedef nlp::converge::converge_criteria_trait<converge_type> converge_trait;
  template <typename nlp_type,
...
template <typename converge_criteria_type, typename nlp_numerical_type>
struct optm_trait<
    second_order::nesterov<converge_criteria_type, nlp_numerical_type>> {
  typedef second_order::nesterov<converge_criteria_type, nlp_numerical_type>
      optm_type;
  typedef typename optm_type::converge_type converge_type;
  typedef nlp::converge::converge_criteria_trait<converge_type> converge_trait;
  template <typename nlp_type,
